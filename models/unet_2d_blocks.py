...
from diffusers.models.resnet import Downsample2D, FirDownsample2D, FirUpsample2D, KDownsample2D, KUpsample2D, Upsample2D
from diffusers.models.transformer_2d import Transformer2DModel

# from resnet import ResnetBlock2D as ConditionResnetBlock2D
...
class UNetMidBlock2DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.resnets[0](hidden_states, temb, scale=lora_scale, image_feature=image_feature)
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
    ...
    def forward(
        ...
        for i, (resnet, attn) in enumerate(blocks):
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states = resnet(hidden_states, temb, scale=lora_scale, image_feature=image_feature)
                hidden_states = attn(
                    hidden_states,
                    encoder_hidden_states=encoder_hidden_states,
                    cross_attention_kwargs=cross_attention_kwargs,
    ...
    def forward(
        ...
        for resnet in self.resnets:
            ...
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states = resnet(hidden_states, temb, scale=scale, image_feature=image_feature)
